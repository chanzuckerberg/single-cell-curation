...
def main():
    ...
    #mtx_file = "./data/original/10X_nuclei_v3_AIBS/matrix.mtx.gz"
    #sample_metadata_file = "./data/original/10X_nuclei_v3_AIBS/sample_metadata.csv"
    #barcodes_file = "./data/original/10X_nuclei_v3_AIBS/barcode.tsv"
    #features_file = "./data/original/10X_nuclei_v3_AIBS/features.tsv.gz"
    #cell_metadata_file = "./data/original/paper_tables/Table_S4_UnimodalClusters/Table_S4f_snRNA_10X_v3_A_metadata.tsv.gz"
    #out_prefix = "./data/transformed/10X_nuclei_v2_AIBS"
