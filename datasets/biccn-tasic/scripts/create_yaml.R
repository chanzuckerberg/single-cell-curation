...
main <- function(cmdArgs=commandArgs(T)) {
    ...
    # Appending to yaml
    yaml_final$obs <- c(yaml_final$obs, list(cell_type_ontology_term_id = list(BICCN_cluster_label = cell_type_yaml)))
...
make_yaml_list <- function() {
    ...
    x <- list(
         ...
         obs = list(assay_ontology_term_id = "EFO:0008930",
                    ...
                    tissue_ontology_term_id = 'UBERON:0002436',
         ...
         uns = list(version = list(corpora_schema_version="1.1.0", corpora_encoding_version="0.1.0"),
                    ...
                    layer_descriptions = list(X = "RPKM", raw.X = "raw"), 
