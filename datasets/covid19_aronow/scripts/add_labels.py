...
dataset = sc.read('../data/original/PBMC_merged_normalized_addRaw_1222.h5ad')
...
dataset.obsm['X_pca'] = pca
dataset.obsm['X_tsne'] = tsne
dataset.obsm['X_umap'] = umap
...
dataset.write('../data/remixed/PBMC_merged_normalized_addRaw_1222.h5ad')
