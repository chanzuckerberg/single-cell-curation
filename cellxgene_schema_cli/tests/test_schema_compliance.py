...
class TestObs:
    ...
    def test_column_presence_organism(self, validator_with_adata):
        ...
        assert validator.errors == [
            ...
            "adata.obs['tissue_ontology_term_id'], this is likely due "
...
#         ["ZFA:0000003", "unknown"],
#     )
#     def test_cell_type_ontology_term_id(
#         self, validator_with_zebrafish_adata, cell_type_ontology_term_id
#     ):
#         """
#         If organism_ontolology_term_id is "NCBITaxon:7955" for Danio rerio,
...
#     @pytest.mark.parametrize(
#         "cell_type_ontology_term_id,error",
#         [
#             (
#                 "CL:0000001",  # Wrong ontology
#                 "ERROR: 'CL:0000001' in 'cell_type_ontology_term_id' is not a valid ontology term id of 'ZFA'.",
#             ),
#             (
#                 "ZFA:0001094",  # Same ontology, not a descendant of ZFA:0009000
#                 "ERROR: 'ZFA:0001094' in 'cell_type_ontology_term_id' is not an allowed term id.",
#             ),
#             (
#                 "ZFA:0009000",  # Do not accept ZFA:0009000 itself, must be a descendant
#                 "ERROR: 'ZFA:0009000' in 'cell_type_ontology_term_id' is not an allowed term id.",
#             ),
#             (
...
#         ],
#     )
#     def test_cell_type_ontology_term_id__invalid(
#         self, validator_with_zebrafish_adata, cell_type_ontology_term_id, error
#     ):
#         validator = validator_with_zebrafish_adata
#         zebrafish_error_message_suffix = (
#             "When 'organism_ontology_term_id' is 'NCBITaxon:7955' (Danio rerio), "
...
#         reason="Skipping this test to unblock downstream multispecies work. TODO: fix before 5.3.0 release"
#     )
#     def test_cell_type_ontology_term_id__visium_in_tissue_0_invalid(
...
#     @pytest.mark.parametrize(
#         "tissue_ontology_term_id,error",
#         [
#             (
#                 "CL:0000001",  # Wrong ontology
#                 "ERROR: 'CL:0000001' in 'tissue_ontology_term_id' is not a valid ontology term id "
#                 "of 'UBERON, ZFA, FBbt, WBbt'.",
#             ),
#             (
#                 "ZFS:0000016",  # Same ontology, not a descendant of ZFA:0100000
#                 "ERROR: 'ZFS:0000016' in 'tissue_ontology_term_id' is not an allowed term id.",
#             ),
#             (
#                 "ZFA:0100000",  # Must be descendant of ZFA:0100000, not itself
#                 "ERROR: 'ZFA:0100000' in 'tissue_ontology_term_id' is not an allowed term id.",
#             ),
#             (
#                 "ZFA:0009000",  # ZFA:0009000 is an explicitly forbidden term
#                 "ERROR: 'ZFA:0009000' in 'tissue_ontology_term_id' is not allowed.",
#             ),
#             (
#                 "ZFA:0000003",  # ZFA:0009000 descendant, an explicitly forbidden ancestor
#                 "ERROR: 'ZFA:0000003' in 'tissue_ontology_term_id' is not allowed. Descendant terms of "
#                 "'ZFA:0009000' are not allowed.",
#             ),
#             (
#                 "na",
#                 "ERROR: 'na' in 'tissue_ontology_term_id' is not a valid ontology term id of 'UBERON, ZFA, FBbt, WBbt'.",
#             ),
#             (
#                 "unknown",
#                 "ERROR: 'unknown' in 'tissue_ontology_term_id' is not a valid ontology term id of 'UBERON, ZFA, FBbt, WBbt'.",
#             ),
#         ],
#     )
#     def test_tissue_ontology_term_id__invalid(
#         self, validator_with_zebrafish_adata, tissue_ontology_term_id, error
#     ):
#         validator = validator_with_zebrafish_adata
#         zebrafish_error_message_suffix = (
#             "When 'organism_ontology_term_id' is 'NCBITaxon:7955' (Danio rerio), "
...
#     )
#     def test_cell_type_ontology_term_id(
#         self, validator_with_fruitfly_adata, cell_type_ontology_term_id
#     ):
#         """
#         If organism_ontolology_term_id is "NCBITaxon:7227" for Drosophila melanogaster,
...
#             (
#                 "CL:0000001",  # Wrong ontology
#                 "ERROR: 'CL:0000001' in 'cell_type_ontology_term_id' is not a valid ontology term id of 'FBbt'.",
#             ),
#             (
#                 "FBbt:00007001",  # Same ontology, not a descendant of FBbt:00007002
#                 "ERROR: 'FBbt:00007001' in 'cell_type_ontology_term_id' is not an allowed term id.",
#             ),
#             (
#                 "FBbt:00007002",  # Do not accept FBbt:00007002 itself, must be a descendant
#                 "ERROR: 'FBbt:00007002' in 'cell_type_ontology_term_id' is not an allowed term id.",
#             ),
#             (
...
#     )
#     def test_cell_type_ontology_term_id__invalid(
#         self, validator_with_fruitfly_adata, cell_type_ontology_term_id, error
#     ):
#         validator = validator_with_fruitfly_adata
...
#                 "ERROR: 'FBbt:10000000' in 'tissue_ontology_term_id' is not an allowed term id.",
#             ),
#             (
#                 "FBbt:00007002",  # FBbt:00007002 is an explicitly forbidden term
#                 "ERROR: 'FBbt:00007002' in 'tissue_ontology_term_id' is not allowed.",
#             ),
#             (
#                 "FBbt:00007294",  # FBbt:00007002 descendant, an explicitly forbidden ancestor
#                 "ERROR: 'FBbt:00007294' in 'tissue_ontology_term_id' is not allowed. Descendant terms of "
#                 "'FBbt:00007002' are not allowed.",
#             ),
#             (
#                 "na",  # Allowed for other organisms, not allowed if organism is zebrafih
#                 "ERROR: 'na' in 'tissue_ontology_term_id' is not a valid ontology term id of 'FBbt, UBERON'.",
#             ),
#             (
#                 "unknown",
#                 "ERROR: 'unknown' in 'tissue_ontology_term_id' is not a valid ontology term id of 'FBbt, UBERON'.",
#             ),
#         ],
#     )
#     def test_tissue_ontology_term_id__invalid(
#         self, validator_with_fruitfly_adata, tissue_ontology_term_id, error
#     ):
#         validator = validator_with_fruitfly_adata
#         zebrafish_error_message_suffix = (
#             "When 'organism_ontology_term_id' is 'NCBITaxon:7227' (Drosophila melanogaster), "
...
#     )
#     def test_cell_type_ontology_term_id(
#         self, validator_with_roundworm_adata, cell_type_ontology_term_id
#     ):
#         """
#         If organism_ontolology_term_id is "NCBITaxon:6239" for C. elegans,
...
#             (
#                 "CL:0000001",  # Wrong ontology
#                 "ERROR: 'CL:0000001' in 'cell_type_ontology_term_id' is not a valid ontology term id of 'WBbt'.",
#             ),
#             (
#                 "WBbt:0000100",  # Same ontology, not a descendant of WBbt:0004017
#                 "ERROR: 'WBbt:0000100' in 'cell_type_ontology_term_id' is not an allowed term id.",
#             ),
#             (
#                 "WBbt:0004017",  # Do not accept WBbt:0004017 itself, must be a descendant
#                 "ERROR: 'WBbt:0004017' in 'cell_type_ontology_term_id' is not an allowed term id.",
#             ),
#             (
#                 "na",  # Allowed for other organisms, not allowed if organism is fruit fly
#                 "ERROR: 'na' in 'cell_type_ontology_term_id' is not a valid ontology term id of 'WBbt'.",
#             ),
#         ],
#     )
#     def test_cell_type_ontology_term_id__invalid(
#         self, validator_with_roundworm_adata, cell_type_ontology_term_id, error
#     ):
#         validator = validator_with_roundworm_adata
#         roundworm_error_message_suffix = (
#             "When 'organism_ontology_term_id' is 'NCBITaxon:6239' (Caenorhabditis elegans), "
...
#     def test_cell_type_ontology_term_id__visium_in_tissue_0__na(self, validator_with_visium_roundworm_adata):
#         validator = validator_with_visium_roundworm_adata
#         error_message = (
#             "ERROR: 'na' in 'cell_type_ontology_term_id' is not a valid ontology term id of 'WBbt'. "
#             "When 'organism_ontology_term_id' is 'NCBITaxon:6239' (Caenorhabditis elegans), "
...
#                 "ERROR: 'WBbt:0005766' in 'tissue_ontology_term_id' is not an allowed term id.",
#             ),
#             (
#                 "na",  # Allowed for other organisms, not allowed if organism is c. elegans
#                 "ERROR: 'na' in 'tissue_ontology_term_id' is not a valid ontology term id of 'WBbt, UBERON'.",
#             ),
#             (
#                 "unknown",
#                 "ERROR: 'unknown' in 'tissue_ontology_term_id' is not a valid ontology term id of 'WBbt, UBERON'.",
#             ),
#         ],
#     )
#     def test_tissue_ontology_term_id__invalid(
#         self, validator_with_roundworm_adata, tissue_ontology_term_id, error
#     ):
#         validator = validator_with_roundworm_adata
#         roundworm_error_message_suffix = (
#             "When 'organism_ontology_term_id' is 'NCBITaxon:6239' (Caenorhabditis elegans), 'tissue_ontology_term_id' MUST be either an UBERON term or the most accurate descendant of WBbt:0005766 for Anatomy excluding WBbt:0007849 for hermaphrodite, WBbt:0007850 for male, WBbt:0008595 for female, WBbt:0004017 for Cell and its descendants, and WBbt:00006803 for Nucleus and its descendants"
#         )
#         obs = validator.adata.obs
#         obs.loc[obs.index[0], "tissue_ontology_term_id"] = tissue_ontology_term_id
#         validator.validate_adata()
#         expected_error = error + " " + roundworm_error_message_suffix
#         assert expected_error in validator.errors
