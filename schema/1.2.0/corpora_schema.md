...
* Added support for additional assays:
  * CITE-seq
  * [#24](https://github.com/chanzuckerberg/single-cell-curation/issues/24), [#27](https://github.com/chanzuckerberg/single-cell-curation/issues/27) Epigenetic assays (ATAC-seq, mC-seq), which do not require "raw" data.
  * Visium experiments
* Added two metadata fields for all assays:
* [#2](https://github.com/chanzuckerberg/single-cell-curation/issues/2) "batch_condition" field to describe batches within the experiment
* [#11](https://github.com/chanzuckerberg/single-cell-curation/issues/11) "primary_data" field to describe
* Changed one metadata field:
  * [#7](https://github.com/chanzuckerberg/single-cell-curation/issues/7), [#8](https://github.com/chanzuckerberg/single-cell-curation/issues/8) Move species from "dataset" metadata to "cell" metadata
