...
* <code>obs['organism_ontology_term_id']</code> values MUST  all be either <code>"NCBITaxon:9606"</code> for <i>Homo sapiens</i> or <code>"NCBITaxon:10090"</code> for <i>Mus musculus</i>. The value determines the required Chromosome Table.
...
* obs (Cell metadata)
  ...
  * Updated the requirements for `assay_ontology_term_id`
    ...
    * Added reference to scATAC-seq fragment asset requirements for _scATAC-seq or a descendant_
