    ...
    <tr>
      <th>Value</th>
        <td>
          ...
          If the values of <code>var['feature_reference']</code> in the associated Dataset include <code>"NCBITaxon:10090"</code> for <i>Mus musculus</i> then the first column value MUST be a value from the <code>Chromosome</code> column in the <a href="#mouse-grcm39">Mouse Chromosome Table</a>.
        </td>
    </tr>
</tbody></table>
<br>
