...
* <code>obs['organism_ontology_term_id']</code> values MUST be all either <code>"NCBITaxon:9606"</code> for <i>Homo sapiens</i> or <code>"NCBITaxon:10090"</code> for <i>Mus musculus</i>. The value determines the required Chromosome Table.
